    ...
    {
        public static class TorrentClientAPI
        {
            ...
            public static async void StartItAllV2()
            {
            ...
            private async static Task ConsoleFeedBack(StringBuilder sb, bool running, int i)
            {
                if ((i++) % 10 == 0)
                {
